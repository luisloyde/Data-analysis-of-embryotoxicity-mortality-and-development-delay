...
```{r}
database <- read_excel("~/Laptop Drive/Toxicología Acuática/Artículos/Resultados para artículo/Data-analysis-of-embryotoxicity-mortality-and-development-delay-in-R/Embriotoxicidad sedimento y agua poro_R.xlsx",range="A1:I31") #this shall be changed in every PC
...
```{r}
gmisedimento<- read_excel("~/Laptop Drive/Toxicología Acuática/Artículos/Resultados para artículo/Data-analysis-of-embryotoxicity-mortality-and-development-delay-in-R/Teratogénesis_R.xlsx", sheet="GMI Sedimento", range="A1:F301") #this shall be changed in every PC
gmiaguaporo<- read_excel("~/Laptop Drive/Toxicología Acuática/Artículos/Resultados para artículo/Data-analysis-of-embryotoxicity-mortality-and-development-delay-in-R/Teratogénesis_R.xlsx", sheet="GMI Agua poro", range="A1:F301") #this shall be changed in every PC
```
...
```{r}
mortalidad_sedimento<-read_excel("~/Laptop Drive/Toxicología Acuática/Artículos/Resultados para artículo/Data-analysis-of-embryotoxicity-mortality-and-development-delay-in-R/p values.xlsx", sheet = "mortalidad_sedimento")
mortalidad_agua<-read_excel("~/Laptop Drive/Toxicología Acuática/Artículos/Resultados para artículo/Data-analysis-of-embryotoxicity-mortality-and-development-delay-in-R/p values.xlsx", sheet = "mortalidad_aguaporo")
...
p<-ggplot(gmi_sed_agua_mean, aes(x = as.factor(Hora), y = promedio, colour=Punto, group=Matriz,shape=Matriz))+
  ...
  theme(axis.line = element_line(colour = "black"))+
  facet_grid(~Punto,scales = "free_x", space = "free_x",switch = "x",labeller=as_labeller(names))+
  scale_fill_discrete(name = "Treatment", labels = c("Control", "P1 (NM)", "P2 (RS)","P3 (RT)","P4 (VM)"))+
#  ylim(0,20)+
...
#  ylim(0,20)+
  ...
  theme(legend.title = element_blank())
p
#ggsave("~/Laptop Drive/Toxicología Acuática/Artículos/Resultados para artículo/Figuras/Gráficas/gms_sediment_porewater.png",width=1800,height=1200,units="px",dpi=200)
...
p3<-ggplot(gmised_mean, aes(x = as.factor(Hora), y = promedio, colour=Punto, group=Matriz))+
  ...
  theme(axis.line = element_line(colour = "black"))+
  facet_grid(~Punto,scales = "free_x", space = "free_x",switch = "x",labeller=as_labeller(names))+
  scale_colour_discrete(name = "Treatment", labels = c("Control", "P1 (NM)", "P2 (SR)","P3 (TR)","P4 (VM)"))+
#  ylim(0,16)+
#  scale_y_continuous(breaks = seq(0,16, by=4))+
  ...
  theme(legend.title = element_blank())
p3
#ggsave("~/Laptop Drive/Toxicología Acuática/Artículos/Resultados para artículo/Figuras/Gráficas/gms_sediment.png",width=1800,height=1200,units="px",dpi=200)
```
...
#  scale_y_continuous(breaks = seq(0,16, by=4))+
  ...
  theme(legend.title = element_blank())
p4
#ggsave("~/Laptop Drive/Toxicología Acuática/Artículos/Resultados para artículo/Figuras/Gráficas/pmg_aguaporo.png",width=1800,height=1200,units="px",dpi=200)
```
...
library(patchwork)
p3+p4
ggsave("~/Laptop Drive/Toxicología Acuática/Artículos/Resultados para artículo/Figuras/Gráficas/gms_sediment_porewater.png",width=4200,height=2400,units="px",dpi=350)
...
EF_plot<- ggplot(EF, aes(x = Site, y = value, fill = Metal)) +
  ...
  annotate("text", x = 2.5, y = c(2, 5, 20), 
           label = c("Enriquecimiento mínimo", "Enriquecimiento moderado","Enriquecimiento significativo"),
           hjust = 0.5, vjust=3, color = "black", size = 3, fontface = "bold")+
  theme(axis.line = element_line(colour="black"))+
  xlab("Sitio")+
  ylab("FE")+
  ggtitle("Factor de enriquecimiento (FE)")+
...
CF_plot<- ggplot(CF, aes(x = Site, y = value, fill = Metal)) +
  ...
  annotate("text", x = 2.5, y = c(1, 3, 6), 
           label = c("Contaminación baja", "Contaminación moderada", "Contaminación considerable"),
           hjust = 0.5, vjust=4, color = "black", size = 3, fontface = "bold") +
  theme(axis.line = element_line(colour="black"))+
  xlab("Sitio")+
  ylab("FC")+
  ggtitle("Factor de contaminación (FC)")+
  scale_fill_discrete(name="Elemento",labels=c("Al","Cd","Fe","Hg","Pb"))+
  guides(fill = guide_legend(ncol = 6))+
  theme(plot.title = element_text(size = 10))+
  theme(legend.title = element_text(size = 10))+
...
mCdeg_plot<- ggplot(mCdeg, aes(x = Site, y = value,fill=Metal)) +
  ...
  annotate("text", x = 2.5, y = 1.5, 
           label = c("Muy baja contaminación"),
           hjust = 0.5, vjust=2, color = "black", size = 3, fontface = "bold")+
  scale_fill_brewer(name = "Elemento",palette = "Set1",labels=c("Elementos en conjunto"))+
  theme(axis.line = element_line(colour="black"))+
  xlab("Sitio")+
  ylab(expression(FCM))+
  ggtitle(expression(Factor~de~contaminación~modificado~(FCM)))+
#  scale_fill_discrete(name="Metal",labels=c("Whole metals"))+
  theme(plot.title = element_text(size = 10))+
  theme(legend.title = element_text(size = 10))+
  theme(legend.text = element_text(size = 10))+
  theme(axis.title = element_text(size = 10))+
